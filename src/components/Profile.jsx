...
const Profile = () => {
  ...
  const [files,setFiles] = useState("")
    ...
    axios.put("https://login-system-with-mongo-ky-vighneshvigh.julyseptoct-node.repl.co/delete",clicked.link).then(data=> {
      console.log(data)
    }).catch(err=> {
      console.log(err)
    })
  ...
  useEffect(()=> {
    axios.get("https://login-system-with-mongo-ky-vighneshvigh.julyseptoct-node.repl.co/files").then(res=> {
  ...
  formData.append("file",state)
    ...
    axios.post("https://login-system-with-mongo-ky-vighneshvigh.julyseptoct-node.repl.co/upload",formData).then(data=> {
      console.log(data.data)

      axios.put("https://login-system-with-mongo-ky-vighneshvigh.julyseptoct-node.repl.co/mongoUpdate")
    }).catch(err=> {
      console.log(err)
    })
